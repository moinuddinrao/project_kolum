const styles = {
  heading1:
    "m-0 p-0 font-ubuntu font-bold text-[48px] leading-[56px] text-nao_black",
  heading2:
    "m-0 p-0 font-ubuntu font-bold text-[32px] leading-[40px] text-nao_dark_gray",
  heading3:
  ...
  box: "flex flex-col gap-10 p-10 bg-white rounded-lg",
};
